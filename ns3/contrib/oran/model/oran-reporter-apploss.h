...
class OranReporterAppLoss : public OranReporter
{
  public:
    ...
    void AddTxWithAddresses(Ptr<const Packet> p, const Address& from, const Address& to);
    void AddRxWithAddresses(Ptr<const Packet> p, const Address& from, const Address& to);
