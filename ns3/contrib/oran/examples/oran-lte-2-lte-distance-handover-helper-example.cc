...
main(int argc, char* argv[])
{
    ...
    // instead of a built-in HO LM
    oranHelper->SetDefaultLogicModule("ns3::OranLmCommandBridge",
                                    "CommandsPath",     StringValue("commands.json"),
                                    "ApplyCioInline",   BooleanValue(true),
                                    "IgnoreOlderThan",  TimeValue(Seconds(120)));
